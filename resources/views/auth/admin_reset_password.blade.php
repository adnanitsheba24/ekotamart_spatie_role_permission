	...
	<div class="row">
        ...
        <form method="POST" action="{{ route('admin.password.update') }}">
            ...
            <div class="footer">
                ...
                <p class="information-text"><span class="symbols" title="Lots of love from me to YOU!">&hearts; </span><a href="#" target="_blank" title="Connect with me on Facebook">Admin Panel Ekota Mart</a></p>
            </div>
