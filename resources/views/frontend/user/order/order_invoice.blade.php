  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        {{-- <td valign="top">
          ...
          <h2 style="color: green; font-size: 21px;"><strong>FM Daily Shop</strong></h2>
        </td> --}}
        ...
        <td align="right">
            <p class="font" >
               {{-- FM Daily Shop Head Office --}}
               Company: {{ @$site_setting->company_name }} <br>
               {{-- Email:salse@fmdailyshop.com <br> --}}
               Email: {{ @$site_setting->email }}<br>
               {{-- Mobile: 01700000000 <br> --}}
               Mobile: {{ @$site_setting->phone_one }}<br>
               {{-- Dhaka 1207,Mirpur:#1 <br> --}}
               Address: {{ @$site_setting->company_address }}<br>
  ...
  <table width="100%" style=" padding:0 10px 0 10px;">
    <tr>
        <td align="right" >
            ...
            <h2><span style="color: green;">Total Due: </span> {{ @$order->amount }} Taka</h2>
