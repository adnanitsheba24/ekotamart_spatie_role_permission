		...
		<div class="container">
			<div class="breadcrumb-inner">
				<ul class="list-inline list-unstyled">
					<li style="margin-top: 70px;"><a href="{{ url('/')}}">Home</a> / Stripe</li>
				</ul>
...
<!-- /////////////////////////////////   Js   //////////////////////////////////-->
        ...
        <script type="text/javascript">
            ...
            var stripe = Stripe('pk_test_51N3uA2LEnu78XM2khmHenh32LOCyndEBic4ohhJwNRY08osFpbOcoACyXszCYKVTDpKQPLYn2kLD98yePy7l7L2L00w7MSB4wi');
