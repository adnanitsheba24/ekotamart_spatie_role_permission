...
@section('title')
Privacy Policy of Ekota Mart
@endsection


<div class="content_one mt-5" style="min-height: 1000px;">
    <div class="container">
        <h1>Privacy Policy of Ekota Mart</h1>
        <p>Ekota Mart.com is determined to bring a large number of products to the doorstep of the e-commerce service of the buyers from home and abroad considering the growing demand of the buyers.</p>
        <p>PRIVACY POLICY

        <h1>Ekota Mart Privacy Policy</h1>

        <p>Ekota Mart (the “Company”) is committed to maintaining robust privacy protections for its users. Our Privacy Policy (“Privacy Policy”) is designed to help you understand how we collect, use, and safeguard the information you provide to us and to assist you in making informed decisions when using our Service.</p>

        <p>For purposes of this Agreement, “Site” refers to the Company’s website, which can be accessed at <a href="http://www.ekotamart.com">www.ekotamart.com</a>. “Service” refers to the Company’s services accessed via the Site, in which users can view our service on our website. The terms “we,” “us,” and “our” refer to the Company. “You” refers to you, as a user of our Site or our Service. By accessing our Site or our Service, you accept our Privacy Policy and Terms of Use (found <a href="http://www.ekotamart.com/privacy-policy">here</a>), and you consent to our collection, storage, use, and disclosure of your Personal Information as described in this Privacy Policy.</p>

        <h2>I. INFORMATION WE COLLECT</h2>

        <p>We collect “Non-Personal Information” and “Personal Information.” Non-Personal Information includes information that cannot be used to personally identify you, such as anonymous usage data, general demographic information we may collect, referring/exit pages and URLs, platform types, preferences you submit, and preferences that are generated based on the data you submit and the number of clicks. Personal Information includes your name, phone number, and email, which you submit to us through the registration process on the Site.</p>

        <p>1. Information collected via Technology</p>

        <p>To activate the Service, you do not need to submit any Personal Information other than your email address. To use the Service thereafter, you need to submit further Personal Information. However, in an effort to improve the quality of the Service, we track information provided to us by your browser or by our software application when you view or use the Service, such as the website you came from (known as the “referring URL”), the type of browser you use, the device from which you connected to the Service, the time and date of access, and other information that does not personally identify you. We track this information using cookies, or small text files that include an anonymous unique identifier. Cookies are sent to a user’s browser from our servers and are stored on the user’s computer hard drive. Sending a cookie to a user’s browser enables us to collect Non-Personal information about that user and keep a record of the user’s preferences when utilizing our services, both on an individual and aggregate basis.</p>
        ...
        <p>In general, we use Non-Personal Information to help us improve the Service and customize the user experience. We also aggregate Non-Personal Information to track trends and analyze use patterns on the Site. This Privacy Policy does not limit our use or disclosure of Non-Personal Information, and we reserve the right to use and disclose such Non-Personal Information to our partners, advertisers, and other third parties at our discretion.</p>
        ...
        <p>If you have any questions regarding this Privacy Policy or the practices of this Site, please contact us by sending an email to info@ekotamart.com.</p>

        <p>Last Updated: This Privacy Policy was last updated on 04-June-2023.</p>
        <p>
            Contact Information:
            Mobile: +8801906-297955
            Email: sales@ekotamart.com
            Website: https://ekotamart.com/
            Address: Mukto Bangla Shopping Complex, 5th Floor, Space No: (51-52), Mirpur-1, Dhaka 1216,
        </p>
    </div>
</div>
@endsection