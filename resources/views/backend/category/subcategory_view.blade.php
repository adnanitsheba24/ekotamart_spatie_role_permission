                        ...
                        @foreach ($subcategory as $key => $item)
                          <tr>
                                ...
                                <td width="30%">
                                    ...
                                    <a href="{{ route('subcategory.delete',$item->id) }}" class="btn btn-danger btn-sm delete_data" title="Delete Data"><i class="fa fa-trash"></i></a>
                                </td>
                          </tr>
                        @endforeach
                      </tbody>
                    ...
                    <div class="table-responsive">
                        <form method="post" action="{{ route('subcategory.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="subcategory_name_en" class="form-control" placeholder="SubCategory english">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="subcategory_name_bn" class="form-control" placeholder="SubCategory bangla">
