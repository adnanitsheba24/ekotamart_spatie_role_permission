            ...
            <div class="col-12">
                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <form method="post" action="{{ route('publication.update', $publications->id) }}">
                            @csrf
                            ...
                            <div class="form-group d-flex justify-content-center">
                                <div class="controls col-md-6">
                                    ...
                                    <input type="text" name="publication_name_en" value="{{ $publications->publication_name_en }}" class="form-control">
                                    @error ('publication_name_en')
                            ...
                            <div class="form-group d-flex justify-content-center">
                                <div class="controls col-md-6">
                                    ...
                                    <input type="text" name="publication_name_bn" value="{{ $publications->publication_name_bn }}" class="form-control">
                                    @error ('publication_name_bn')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            </div>
                                ...
                                <div class="col-md-6 mt-5" style="margin-top: -70px;"> 
                                    ...
                                    <div class="controls">
                                        <label class="container">Active / In-active
                                            <input type="checkbox" value="1" name="status" {{ $publications->status == 1 ? 'checked' : '' }} >
