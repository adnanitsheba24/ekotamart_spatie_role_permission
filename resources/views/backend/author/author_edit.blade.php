                        ...
                        <form method="post" action="{{ route('author.update', $authors->id ) }}">
                                ...
                                <div class="controls col-md-6">
									...
									<select name="category_id" class="form-control">
                                        ...
                                        @foreach($categories as $category)
                                            <option value="{{ $category->id }}" {{ $category->id == $authors->category_id ? 'selected' : '' }}>{{ $category->category_name_en }}</option>
                                        @endforeach
									</select>
                                ...
                                <div class="controls col-md-6">
									...
									<select name="book_type_id" class="form-control">
                                        ...
                                        @foreach($book_types as $book_type)
                                            <option value="{{ $book_type->id }}" {{ $book_type->id == $authors->book_type_id ? 'selected' : '' }}>{{ $book_type->book_type_name_en }}</option>
                                        @endforeach
									</select>
                                ...
                                <div class="controls col-md-6">
									...
									<select name="publication_id" class="form-control">
                                        ...
                                        @foreach($publications as $publication)
                                            <option value="{{ $publication->id }}" {{ $publication->id == $authors->publication_id ? 'selected' : '' }}>{{ $publication->publication_name_en }}</option>
                                        @endforeach
									</select>
                            ...
                            <div class="form-group d-flex justify-content-center">
                                <div class="controls col-md-6">
                                    ...
                                    <input type="text" name="author_name_en" value="{{ $authors->author_name_en }}" class="form-control">
                            ...
                            <div class="form-group d-flex justify-content-center">
                                <div class="controls col-md-6">
                                    ...
                                    <input type="text" name="author_name_bn" value="{{ $authors->author_name_bn }}" class="form-control">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <label class="container">Active / In-active
                                                <input type="checkbox" value="1" name="status" {{ $authors->status == 1 ? 'checked' : '' }} >
