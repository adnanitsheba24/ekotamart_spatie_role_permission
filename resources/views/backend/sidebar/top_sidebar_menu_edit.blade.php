       ...
       <!-- Basic Forms -->
        <div class="box">
          <div class="box-header with-border">
            <h4 class="box-title">Edit Top Sidebar Menu</h4>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <div class="row">
              <div class="col">
                  <form method="post" action="{{ route('top_sidebar.update', $top_sidebar->id) }}" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="row"> <!-- start 2nd row -->
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="name_en" value="{{ $top_sidebar->name_en }}" class="form-control" placeholder="English name"> 
                                                @error ('name_en')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="name_bn" value="{{ $top_sidebar->name_bn }}" class="form-control" placeholder="Bangla name"> 
                                                @error ('name_bn')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror 
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="number" name="priority" value="{{ $top_sidebar->priority }}" class="form-control" placeholder="Top sidebar priority"> 
                                                @error ('priority')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror 
                                            </div>
                                    ...
                                    <div class="controls col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            URL::to('storage/top_sidebar_icon', $top_sidebar->icon) : url('upload/no_image.jpg') }}" alt="Top Sidebar Icon">
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <label class="container">Active / In-active
                                                    <input type="checkbox" value="1" name="status" {{ $top_sidebar->status == 1 ? 'checked' : '' }} >
