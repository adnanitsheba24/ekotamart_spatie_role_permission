...
class PermissionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.role_and_permission.permission_view', compact('permissions'));
    }
    ...
    {
        $roles = Role::all();
        return view('backend.role_and_permission.permission_edit', compact('permission', 'roles'));
    }
